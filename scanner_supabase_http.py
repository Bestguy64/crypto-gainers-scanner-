...
# Supabase REST-backed crypto scanner (no psycopg2)
# Uses Supabase REST (PostgREST) with the service role key for dedupe and inserts.
...
# ---- Supabase REST helpers (dedupe + record)
...
# ---- CoinGecko & exchange helpers (same logic as before)
